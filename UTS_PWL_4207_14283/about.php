        ...
        <header>
            ...
            <nav>
                <ul>   
                    ...
                    <li> <a href="index.php?logout=<?php echo $user_id; ?>" onclick="return confirm('are your sure you want to logout?');" class="delete-btn">Logout</a>
        ...
        <footer>
            <div class="main-content">
                <div class="left box">
                    <h2>ABOUT ME</h2>
                    <div class="content">
                        <p>Ostyle Shop is an e-commerce website that sells various kinds of the latest fashion at 
                ...
                <div class="center box">
                    ...
                    <div class="content">
                        <div class="place">
                            ...
                            <span class="text">Kota Semarang, Jawa Tengah</span>
                        </div>
                        <div class="phone">
